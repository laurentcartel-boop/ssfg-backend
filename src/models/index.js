...
const TribunePick = require('./TribunePick');
...
TribunePick.belongsTo(User, { foreignKey: 'user_id', as: 'user', constraints: false });
User.hasMany(TribunePick, { foreignKey: 'user_id', as: 'tribunePicks', constraints: false });
