...
try {
  ...
  console.warn('Modeles Marcassins absents:', e.message);
}
...
User.hasMany(PushSubscription, { foreignKey: 'user_id', as: 'pushSubs', constraints: false });
PushSubscription.belongsTo(User, { foreignKey: 'user_id', as: 'user', constraints: false });
