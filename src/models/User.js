...
const User = sequelize.define('User', {
  ...
  role: {
    type: DataTypes.ENUM('joueur', 'admin', 'super_admin', 'platine_admin'),
    defaultValue: 'joueur',
    allowNull: false,
  },
  index_value: { type: DataTypes.DECIMAL(5, 1), defaultValue: 1.0, allowNull: false },
  gender: { type: DataTypes.ENUM('M', 'F', 'other'), allowNull: true },
  birth_date: { type: DataTypes.DATEONLY, allowNull: true },
  is_rookie: { type: DataTypes.BOOLEAN, defaultValue: false },
  last_round_date: { type: DataTypes.DATEONLY, allowNull: true },
  ...
  card_nickname: { type: DataTypes.STRING(40), allowNull: true },
  card_bio: { type: DataTypes.STRING(280), allowNull: true },
  card_photo: { type: DataTypes.TEXT('long'), allowNull: true },
}, {
  tableName: 'users',
  hooks: {
