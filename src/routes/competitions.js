...
router.post('/:id/registrations', requireRole('admin', 'super_admin', 'platine_admin'), competitionController.addRegistrations);
...
router.post('/:id/launch', requireRole('admin', 'super_admin', 'platine_admin'), competitionController.launchCompetition);
router.post('/:id/close', requireRole('admin', 'super_admin', 'platine_admin'), competitionController.closeCompetition);
